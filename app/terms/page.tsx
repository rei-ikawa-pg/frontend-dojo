  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-12 md:px-8 md:py-16">
      <Prose>
        ...
        <h2>1. 本サイトの目的</h2>
        <p>
          {SITE.name}（本サイト）は、フロントエンド技術の学習・教育を目的とした個人運営のサイトです。
        ...
        <ul>
          ...
          <li>
            本サイトのインタラクティブ機能は、一部のブラウザ（主に Chromium 系）でのみ完全に動作します。
            他のブラウザでは機能が制限される旨を明示しています。
          </li>
        </ul>
        ...
        <h2>5. サービスの変更・停止</h2>
        <p>
          運営者は、事前の通知なく本サイトの内容変更・一時停止・終了を行うことがあります。
        </p>

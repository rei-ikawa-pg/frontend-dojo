...
export const metadata: Metadata = {
  title: '修行ロードマップ',
  description: 'フロントエンド道場の Phase 構成と今後追加予定の Lab 一覧。',
...
const PHASES: readonly {
...
}[] = [
  {
    status: 'published',
    title: 'Phase 1 / 公開中',
    subtitle: 'レンダリングパイプラインを中心にした初回公開版',
  },
  ...
  { status: 'phase-3', title: 'Phase 3', subtitle: 'スクロールジャンクの稽古場を追加' },
  {
    status: 'formal',
    title: '正式版以降',
    subtitle: 'React 再レンダー、Canvas/WebGL、イベントループ',
  },
]
    ...
    <div className="mx-auto w-full max-w-4xl px-4 py-12 md:px-8 md:py-16">
      <header className="mb-10">
        ...
        <p className="mt-3 text-muted-foreground">
          フェーズごとに Lab を追加していきます。 「こんな稽古場が欲しい」という意見は
          <a

...
export const TUTORIAL_STEPS: readonly TutorialStep[] = [
  {
    ...
    preset: { elementCount: 120, enabledProps: [], autoStart: false },
  },
  {
    id: 2,
    ...
    preset: { elementCount: 200, enabledProps: ['width'], autoStart: true },
  ...
  },
  {
    ...
    preset: { elementCount: 200, enabledProps: ['background-color'], autoStart: true },
  ...
  },
  {
    ...
    preset: { elementCount: 300, enabledProps: ['transform'], autoStart: true },
    focus: ['fps', 'rendering'],
  },
  {
    id: 5,
    ...
    preset: { elementCount: 200, enabledProps: ['opacity'], autoStart: true },
  ...
  },
  {
    ...
    preset: { elementCount: 150, enabledProps: [], autoStart: true },
    comparison: {
  ...
  },
  {
    ...
    preset: { elementCount: 200, enabledProps: ['transform'], autoStart: false },
  },
] as const

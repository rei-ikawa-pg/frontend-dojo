...
export function HeaderBar({ right, contained = false, onBrandNavigate }: Props) {
  const rowClass = contained
    ? 'mx-auto flex h-[72px] w-full max-w-7xl items-center justify-between gap-6 border-b border-rule-dim px-5 md:px-8'
    : 'flex h-[72px] items-center justify-between gap-6 border-b border-rule-dim px-5'
